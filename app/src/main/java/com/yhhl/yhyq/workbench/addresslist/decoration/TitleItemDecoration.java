package com.yhhl.yhyq.workbench.addresslist.decoration;
...
import com.yhhl.yhyq.workbench.addresslist.IndexBar.bean.BaseIndexTagBean;
...
//    private static int COLOR_TITLE_FONT = Color.parseColor("#FF999999");
    ...
    private static int COLOR_TITLE_FONT = Color.parseColor("#2366F2");
...
/*
        ...
        c.drawText(mDatas.get(position).getBaseIndexTag(), child.getPaddingLeft(), child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2)+20, mPaint);
    }
