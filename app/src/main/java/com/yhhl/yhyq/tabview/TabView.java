...
public class TabView extends RelativeLayout {
     ...
     */
    private int mImageViewWidth, mImageViewWidth_;
    /**
     * the imageview`s height,default height is 30dip
     */
    private int mImageViewHeight, mImageViewHeight_;
    /**
    ...
    private void initDefaultAttrs(Context context) {
        mTextViewSelColor = Color.rgb(0, 0, 0);//Color.rgb(252,88,17);
        ...
        mImageViewWidth = TabViewUtil.dp2px(context, 22);
        mImageViewHeight = TabViewUtil.dp2px(context, 23);

        mImageViewWidth_ = TabViewUtil.dp2px(context, 22);
        mImageViewHeight_ = TabViewUtil.dp2px(context, 23);
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.TabView_tab_textViewSelColor) {
            ...
            mImageViewWidth_ = typedArray.getDimensionPixelSize(attr, mImageViewWidth_);
            ...
            mImageViewHeight_ = typedArray.getDimensionPixelSize(attr, mImageViewHeight_);
    ...
    private void initTabChildView() {
        ...
        for (int i = 0; i < mTabViewChildList.size(); i++) {
            ...
            LinearLayout.LayoutParams  ivParams = new LinearLayout.LayoutParams(
                    mImageViewWidth_, mImageViewHeight_
            );
